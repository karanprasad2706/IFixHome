...
public class category_speakers extends AppCompatActivity implements CardAdapter.OnItemClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_category_speakers);

        // Back button
        ImageButton btn1 = findViewById(R.id.backButton6);
        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(category_speakers.this, Homepage.class));
            }
        });
...
// Example items for speaker services
        ...
        RecyclerView recyclerView = findViewById(R.id.speakersRecyclerView);
    ...
    public void onItemClick(Product product) {
        Intent intent = new Intent(category_speakers.this, single_product_details.class);
